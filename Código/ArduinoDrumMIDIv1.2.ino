...
/**@brief La funcion MIDI_CREATE_DEFAULT_INSTANCE Configura el puerto USB para la transferencia de datos MIDI.
*/
...
*/
/**Se asigna una etiqueta al puerto analogico "A0" del Arduino.*/
const short drumPad1 = A0;
/**Se asigna una etiqueta al puerto analogico "A1"del Arduino.*/
const short drumPad2 = A1;
/**Se asigna una etiqueta al puerto analogico "A2" del Arduino.*/
const short drumPad3 = A2;
/**Se asigna una etiqueta al puerto analogico "A3"del Arduino.*/
const short drumPad4 = A3;
/**Se asigna una etiqueta al puerto analogico "A4" del Arduino.*/
...
*/
/**Variable que almacena el sonido correspondiente a la tarola*/
const byte tarola = 38;
/**Variable que almacena el sonido correspondiente al bombo*/
const byte bombo = 36;
/**Variable que almacena el sonido correspondiente al hihat cerrado*/
const byte hihatCerrado = 53;
/**Variable que almacena el sonido correspondiente al crash*/
const byte crash = 77;
/**Variable que almacena el sonido correspondiente al hihat abierto*/
const byte hihatAbierto = 56;

/**@struct drumpad
*@brief Estructura que representara a cada uno de los drumpads y sus propiedades.
*/
struct drumpad{
  short etiqueta, nota;
...
/**@typedef Drumpad
*@brief Cambio de nombre de struct drumpad a Drumpad para facilitar su uso
*/
